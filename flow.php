                    ...
                    <table>
                        <thead>
                            <tr class="filters">
                                ...
                                <th><input type="text" class="form-control" placeholder="Proto."></th>
                                ...
                                <th><input type="text" class="form-control" placeholder="Packet"></th>
                                <th><input type="text" class="form-control" placeholder="Byte"></th>
                            </tr>
                        </thead>
                    </table>
                </div>
